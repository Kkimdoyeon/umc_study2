...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -420126511L;
    ...
    public final umc.umc_study_2.domain.QMission mission;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc.umc_study_2.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
